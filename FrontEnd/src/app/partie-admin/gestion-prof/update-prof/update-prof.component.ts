...
export class UpdateProfComponent implements OnInit {
 ...
 telephone : new FormControl('', [
  ...
  updateProfesseur(){
    ...
    let prof=new Professeur(data.nom, data.prenom, data.email, data.mot_passe,'professeur',data.telephone, data.niveau,this.infoProf.date_embauche, data.genre, true, this.infoProf.photo) ;
